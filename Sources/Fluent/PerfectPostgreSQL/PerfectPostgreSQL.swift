...
public var postgresConnector: PostgresDatabaseConfiguration? = nil
public var postgresDB: Database<PostgresDatabaseConfiguration> {
    get {
        return Database(configuration: postgresConnector!)
    }
}
